...
const Totalsec=30;
function Game1Video1(props){
    const navigate=useNavigate()
    // console.log("props is")
    var [sec,setSec]=useState(Totalsec)
        ...
        <div>
            ...
            //  }}
             >
                            ...
                            <div style={{textAlign:'center',fontSize:24}} >Score is {Blinks}</div>
                     ...
                     <div className='game1-score-text'>Score : {Blinks}</div>
                        ...
                        <div className='home-s2-title'>Game Is Over</div>
                            ...
                            <button className='home-s3-btn'  style={{marginTop:30}} onClick={
                                ()=>{
                                    navigate('/Game1/Completed',{state:data})
                                }
                            } >Winner</button>
                             </div>
                            </div>
