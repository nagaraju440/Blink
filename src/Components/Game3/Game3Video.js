...
function Game3Video(props){
    ...
    function onResults(results){
        ...
        if (results.multiFaceLandmarks) {
          ...
          //  ...................................Left eye........................................
            ...
            if(lRatio+rRatio>8.7){
   
                 if(lRatio<6 && rRatio>6){
                    min=Math.max(lRatio+rRatio);
                    // console.log("ans is",lRatio+rRatio,lRatio,rRatio)
                    // alert(lRatio+rRatio)
                    setTimeout(()=>{
                       isClosed=1
                       setIsClosed(1)
          ...
          if(index+1<data.length){
           ...
           setGameOver(1)
                       ...
                       console.log("ghehehhehhehhee",min)
                    },2000)
                 }
                 if(lRatio>6 && rRatio<6){
                    min=Math.max(lRatio+rRatio);
          ...
          if(index+1<data.length){
           ...
           setGameOver(1)
                ...
                // console.log("l rati/o is",lRatio)
                // console.log("r ratio is",rRatio)
            //    alert("lratio is",lRatio,"rratio is",rRatio)
            }
            //  alert(lRatio,"and",rRatio)
   ...
   console.log("i am from set Interval",sec)
    if(isClosed===1){
       ...
       console.log("index",index,"next pperson is",data[index],min)
    }
     },1000)
   }
   const updateBlinks=()=>{
                     ...
                     <div className='game1-score-text'>Score : {sec}</div>
                        ...
                        <div className='home-s2-title'>Game Is Over</div>
                            ...
                            <button className='home-s3-btn'  style={{marginTop:30}} onClick={
                                ()=>{
                                    navigate('/Game3/Completed',{state:data})
                                }
                            } >Winner</button>
                             </div>
                            </div>
